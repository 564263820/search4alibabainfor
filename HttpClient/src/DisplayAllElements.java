...
public class DisplayAllElements {
	public static void main(String[] args) throws Exception {
		...
		Source source=new Source(CompactSource.class.getClassLoader().getResourceAsStream("data/form.html"));
		...
		Object obj = engine.eval("var window={};var document={}; var a=1; var b=2;add(a,b); function add(a,b){return a+b;}; //");
