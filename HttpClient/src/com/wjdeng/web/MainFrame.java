...
public class MainFrame extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher  dis= getServletContext().getRequestDispatcher("/"+model+"input.jsp");
	...
	private String creatPageFlag(String url){
		...
		//}
		this.getServletContext().setAttribute("pageFlag_wjdeng", "pageFlag_wjdeng");
		String flagtag = "<input name='pageFlag_wjdeng' value='"+frameId+"' id='pageFlag_wjdeng' />";
		flagtag += "<input name='PageSrcUrl' value='"+url+"' id='PageSrcUrl' />";
		return flagtag;
	}
